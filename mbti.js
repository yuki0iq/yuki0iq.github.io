...
function recalc() {
	...
	str += table([
		...
		tr([td( NiT), td( NeT), td( SiT), td( SeT), td( FiT), td( FeT), td( TiT), td( TeT), td('Трикстер [убран из этой версии]')]),
	])
	...
	str += p('Возможный разброс баллов от -315 до 540, набранный разброс от ' + mbti[0][0] + ' до ' + mbti[15][0] + ': величина разброса ' + (mbti[15][0] - mbti[0][0]))
