...
question_sets = [
	...
	['Основные страхи и подсознательные детские желания', '', 4, 1, [
	...
	['Красные флаги', 'Красный флаг - это дополнительная боязнь, которая появляется у каждого типа в стрессовом состоянии. По сути, ещё один страх, присущий каждому из типов', 4, 1, [
...
function recalc() {
	...
	str += '</tr>'
	str += '</table>'
	str += 'Возможный разброс баллов от -11 до 22'
	...
	for (i of [[E2, '2'], [E3, '3'], [E4, '4']]) {
		for (j of [[E5, '5'], [E6, '6'], [E7, '7']]) {
			for (k of [[E8, '8'], [E9, '9'], [E1, '1']]) {
				tritype.push([i[0] + j[0] + k[0], i[1] + '-' + j[1] + '-' + k[1]])	//ijk
			}
		}
	}
	...
	str += '</table>'
	str += 'Наиболее вероятный тритип: <b>' + tritype[26][1] + '</b>. Возможный разброс баллов от ?? до ??'
