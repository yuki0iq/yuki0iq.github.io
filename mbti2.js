...
vNiV = [aNiU, aNiU, aNiU, aNiU]
vNeV = [aNeU, aNeU, aNeU, aNeU]
vSiV = [aSiU, aSiU, aSiU, aSiU]
vSeV = [aSeU, aSeU, aSeU, aSeU]
// trixter
...
question_sets = [
	...
	['Головокружение', 'Опиши головокружение и сравни его с четырьмя примерами', 4, 1, [
		['Описывая головокружение, я привожу ассоциации', [vNeV]],
		['Описывая головокружение, я обращаю внимание на всплывающие в моей голове внутренние образы, мысли, на визуализированные внутренние объекты (Например: "Головокружение ощущается как размытое кистью изображение", "Когда я описывал головокружение, в моей голове всплыла картинка человечка из комикса со звёздочками вокруг своей головы")', [vNiV]],
		['Описание головокружение вызывает у меня трудности, обычно я просто перечисляю основные физические ощущения', [vSeV]],
		['Описывая головокружение, я рассказываю точные подробные физические ощущения, расписывая их до мелочей', [vSiV]],
	]],
