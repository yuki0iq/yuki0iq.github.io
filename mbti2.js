...
question_sets = [
  ['Ne против Ni', '', 4, 2, [
    ...
    ['Я постоянно отвлекаюсь', [aNe, RA(aNi)], 'У меня есть склонности к некропостингу'],
  ...
  ['Когнитивные оси - часть 1', 'Fi/Te против Fe/Ti', 4, 2, [
  ...
  ['Когнитивные оси - часть 2', 'Ni/Se против Ne/Si', 4, 2, [
  ...
  ['Проявления когнитивных функций - часть 1', 'Что тебя удерживает в хорошем настроении?', 4, 1, [
...
for (i = 0; i < question_sets.length; i += 1) {
  ...
  // <=== if question set is "L <-> R" shuffle each question!
}
