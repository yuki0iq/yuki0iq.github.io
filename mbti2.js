...
question_sets = [
  ...
  ['Грипы', 'Грипы - это стрессовое использование только четвертой функции', 4, 1, [
    ...
    ['Если видишь успех другого человека, хочется для всех доказать, что ты – гораздо лучше, чем он', vgTe],
    ['Часами напролёт усердно работаешь для достижения цели, напрочь забывая об отдыхе', vgTe],
    ['Многие люди для вас кажутся беспомощными', vgTe],
    ['Одержимость быть лучще всех', vgTe],
    ['Точно знаешь, чего хотите, и уверен в том, что ты это получишь', vgTe],
    ['У меня начинается поток ужасных неконтролируемых мыслей', vgNi],
    ...
    ['Слишком осведомлен о своем физическом самочувствии, чувствую себя больным; возможно чрезмерно беспокоюсь о своём здоровье', vgSi],
    ...
    ['Меня тянет на причинение себе вреда (порезы, алкоголь)', vgSe],
