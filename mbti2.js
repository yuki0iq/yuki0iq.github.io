...
question_sets = [
  ...
  ['Когнитивные оси - часть 1', 'Fi/Te против Fe/Ti', 5, 2, [
    ...
    ['TODO В сильном стрессе я чувствую что общественные нормы угнетают меня, поэтому я пытаюсь защититься путём сохранения независимости мышления', [aFeTi, RA(aFiTe)], 'В сильном стрессе я чувствую что внешние безличные системы меня дехуманизируют, поэтому я защищаюсь путём выяснения того, что мне действительно важно и кто я есть на самом деле'],
