...
question_sets = [
  ['Ne против Ni', '', 5, 2, [
    ['При восприятии информации обращаю внимание на символы и образы, что всплывают в вашем сознании', [aNe, RA(aNi)], 'При восприятии информации обращаю внимание на возможности и потенциальные варианты реализации идей (даже если не планирую их реализовывать)'],
