...
question_sets = [
  ['Ne против Ni', '', 5, 2, [
    ...
    ['При выражении своего мнения или позиции чаще использую ассоциации', [aNe, RA(aNi)], 'При выражении своего мнения или позиции чаще пытаюсь более дословно передать суть через метафоры'],
  ...
  ['Лупы', 'Лупы - это стрессовое использование первой и третьей функций с игнорированием второй и четвертой. Луп проявляется при слабом стрессе', 4, 1, [
    ]],
  ['Грипы', 'Грипы - это стрессовое использование только четвертой функции. Грип проявляется при сильном стрессе', 4, 1, [
    ...
    ['Если видишь успех другого человека, хочешь всем доказать, что ты – гораздо лучше, чем он', vgTe],
    ['Часами напролёт усердно работаешь для достижения цели, напрочь забывая об отдыхе', vgTe],
    ['Многие люди кажутся беспомощными', vgTe],
    ['Одержимость быть лучще всех', vgTe],
    ['Точно знаешь, чего хочешь, и уверен в том, что ты это получишь', vgTe],
    ['Начинается поток ужасных неконтролируемых мыслей', vgNi],
    ['Продумываешь в голове самые худшие сценарии развития событий', vgNi],
    ['Менее терпим и легче раздражаешься', vgNi],
    ['Становишься очень подозрительным ко всему', vgNi],
    ['Становишься рассеянным и забывчивым', vgNi],
    ['Постоянное плохое предчувствие', vgNi],
    ['Отвлекаешься на тревожные внутренние образы', vgNi],
    // <==Ne (after)
    ['Появляется сильное желание изменить прошлое: "Если бы я поступил иначе, этого бы не произошло..."', vgSi],
    ['Ощущение, будто ты упустил нечто хорошее', vgSi],
    ['Неприязнь к "себе из прошлого"', vgSi],
    ['Становишься параноиком; очень критичен ко всему, иногда дотошный', vgSi],
    ['Слишком осведомлен о своем физическом самочувствии, чувствуешь себя больным; возможно чрезмерно беспокоишься о своём здоровье', vgSi],
    ['Часто преувеличиваешь проблемы', vgSi],
    ['Стремишься к стабильности для того, чтобы почувствовать безопасность, хотя раньше такого за собой не замечал (только в стрессе)', vgSi],
    ['Торопливость и импульсивность', vgSe],
    ['Паникуешь и можешь впасть в истерику', vgSe],
    ['Слишком налегаешь на еду', vgSe],
    ['Уделяешь внимание телу (длительный душ/ванные, уход за собой)', vgSe],
