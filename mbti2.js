...
question_sets = [
  ...
  ['Лупы', 'Лупы - это использование первой и третьей функций с игнорированием второй', [
    ]],
  ['Грипы', 'Грипы - это использование первой и четвертой функций с игнорированием второй', [
    ]]
]
