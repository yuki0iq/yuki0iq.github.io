question_sets = [
  ...
  ['Основные страхи и подсознательные детские желания', '', 0, [
  ...
  ['Красные флаги', 'Красный флаг - это дополнительная боязнь, которая появляется у каждого типа в стрессовом состоянии. По сути, ещё один страх, присущий каждому из типов', 0, [
